...
Through using package 'listings', \gls{MultEdu} can implement this in very good quality.
...
A 'listings' csomag felhasználásával a \gls{MultEdu} ezt jó minőségben tudja biztosítani.
...
\gls{MultEdu} pre-sets some style and allows to modify it as much as you like.
...
A \gls{MultEdu} beállít valamilyen alap-stílust,
amit tetszés szerinti alkalommal és módon módosíthatunk.
...
Possible keys: \lstinline|wide[=false],decorations[=\{\}]|.
...
Lehetséges kulcs: \lstinline|wide[=false],decorations[=\{\}]|.
...
while the wide lists span the width of both columns.
...
\par\noindent ahol a díszítések listája a szakaszban felsorolt 
bármelyik fajta díszítést tartalmazhatja.\ao{\footnote{
...
\MESourceBalloonComment{HelloCBalloon}{-1cm,0cm}{This is the body}{CommentShape}
}
...
\\MESourceBalloonComment \{HelloCBalloon\} \{0cm,0cm\} \{This is the body\} \{CommentShape\}
\} 
] \{lst/HelloWorld.cpp\} \{"Hello World" -- egy C++ program
%, megjegyzés a kijelöléshez
\} \{lst:HLhello.cpp\}\{\}|
...
\MESourceBalloonComment{HelloBalloonC}{-1cm,0cm}{Ez a csoport}{CommentShape}
}
]{lst/HelloWorld.cpp}{"Hello World" -- egy C++ program %, megjegyzés a kijelöléshez
}{lst:HLChello.cpp}{}
...
\\MESourceFile[language=\{[ISO]C++\},
decorations=\{
\\MESourcelineComment\{lst:Chello.cpp\} \{6\} \{-1cm,0cm\} \{This is a comment\} \{CommentShape\}
\}
...
\MESourceFile[language={[ISO]C++},
decorations={
\MESourcelineComment{lst:Chello.cpp}{6}{-1cm,0cm}{Ez megjegyzés}{CommentShape}
}
...
\item a golyók számozása a \lstinline|number[=1]| értéktől indul.
\end{itemize}
...
\MESourceFile[language={Verilog},wide,
decorations={
\MESourcelineFigure[width=5.2cm]{lst:forloops.v}{3}{2.7,-.1}{fig/forloops}
}
]{lst/forloops.v}{Implementing \ctext{for} loop with repeating HW}{lst:forloops.v}{}
}
{Ábra elhelyezése a programlistán}
