...
\MEDchapter[Customizing]{Customizing document}{Finomhangolás}{Finomhangolás}
...
\MEDframe{Facilities to set options for \lstinline|MultEdu|}
{
...
\MEDsection[Options]{Options for using package \lstinline|MultEdu|}{Beállítások}{A \lstinline|MultEdu| csomag beállítási lehetőségei}
...
{
\gls{MultEdu} allows to utilize two popular screen widths.
...
{Képernyő szélesség}
{
A \gls{MultEdu} lehetővé teszi kétféle elterjedt formátum használatát.
...
\MEDsection[Files]{Files for package \lstinline|MultEdu|}{Fájlok}{A \lstinline|MultEdu| csomag fájljai}
