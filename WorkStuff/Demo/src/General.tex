...
\MEDsubsection[Heading]{\ctext{Heading}}{Alapértelmezett}[Heading]{\ctext{Heading}}{Alapértelmezett}

\MEDframe{File \ctexf{Heading}}
{
...
\MEDframe{File \ctexf{Heading}}
{ When using dual-language source files, 
...
\MEDframe{File \ctexf{Heading}}
{
Also here we can give e-mail address
