...
\tikz[remember picture,overlay]%
	\node[anchor=east]
	at ([yshift=-80pt,xshift=-100pt]current page.north east) (subtitle)
...
\tikz[remember picture,overlay]%
	\node[anchor=east]
	at ([yshift=120pt,xshift=-100pt]current page.south east) (subtitle)
	{\parbox[t]{.7\paperwidth}{\raggedleft\usebeamerfont{subtitle}{    \begin{mybox}[]
...
\tikz[remember picture,overlay]%
			...
			at ( [yshift=-5pt,xshift=80pt]	current page.south west) (logo)
...
\tikz[remember picture,overlay]%
			\node[anchor=south west] 
			at ( [yshift=-5pt,xshift=0pt]	current page.south west) (logo)
			{\TitlePictureLogo{\raisebox{-.5ex}\TitleTextLogo}
						};
		}
