...
\setbeamertemplate{footline}{\raisebox{-2ex}{\pgfuseimage{textlogo}}
  \usebeamerfont{date in head/foot}\quad\LecturePublisher\hfill
...
{\def\TitleTextLogo{\includegraphics[height=1cm]{../../common/images/fig/LatexText}}
    \pgfdeclareimage[height=.5cm]{textlogo}{../../common/images/fig/LatexText}
    }
