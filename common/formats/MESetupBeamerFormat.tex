...
{ % Make a text-only title page
	...
	{\parbox[t]{.8\paperwidth}{\raggedright\usebeamerfont{subtitle}\textcolor{black}{\scriptsize \copyright \LectureAuthor\ \\\LectureRevision\ (using\ \MERevision)\ \LectureEmail}}};
	  ...
	  %% We can use logos, either custom logos or default ones
		...
		{ % No user logo, use the default one
			...
			{\includegraphics[width=2cm]{../../common/images/LatexTalk.png}\raisebox{.5ex}
						{\tiny{\ \LectureRevision\ (using\ \MERevision}) \ \copyright \LectureAuthor\ (\LectureEmail)}};
		}
