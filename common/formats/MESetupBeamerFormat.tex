...
\AtBeginSection[]
{
\ifthenelse{\isempty{\MEchapterillustration}}
...
\tikz\node[opacity=0.3] {\includegraphics[height=\paperheight,width=\paperwidth]{fig/illustration_tour}};}
