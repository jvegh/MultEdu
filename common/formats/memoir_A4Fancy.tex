...
\tikz[remember picture,overlay]%
	\node[anchor=east]
	at ([yshift=-90pt,xshift=-20pt]current page.north east) (subtitle)
...
\tikz[remember picture,overlay]%
	\node[anchor=east]
	at ([yshift=120pt,xshift=-20pt]current page.south east) (subtitle)
	{\parbox[t]{.7\paperwidth}{\raggedleft\usebeamerfont{subtitle}{    \begin{mybox}[]
...
\tikz[remember picture,overlay]%
			\node[anchor=east] 
			at ( [yshift=45pt,xshift=0pt]	current page.south east) (logo)
